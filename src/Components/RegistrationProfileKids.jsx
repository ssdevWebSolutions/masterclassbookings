      ...
      <Card className="shadow mb-4" style={{ borderRadius: '1rem', border: '2px solid #FFD700' }}>
        ...
        <Card.Body>
          <Form onSubmit={handleAddOrUpdateKid}>
            <Row className="mb-3">
              <Col md={6}><Form.Group controlId="kidFirstName"><Form.Label>First Name*</Form.Label><Form.Control type="text" placeholder="First Name" name="firstName" value={newKid.firstName} onChange={handleKidChange} required /></Form.Group></Col>
              <Col md={6}><Form.Group controlId="kidLastName"><Form.Label>Last Name*</Form.Label><Form.Control type="text" placeholder="Last Name" name="lastName" value={newKid.lastName} onChange={handleKidChange} required /></Form.Group></Col>
            </Row>
            <Row className="mb-3">
              <Col md={4}><Form.Group controlId="kidAge"><Form.Label>Age*</Form.Label><Form.Control type="number" placeholder="Age" name="age" value={newKid.age} onChange={handleKidChange} required /></Form.Group></Col>
              <Col md={4}><Form.Group controlId="kidClub"><Form.Label>Club</Form.Label><Form.Control type="text" placeholder="Club" name="club" value={newKid.club} onChange={handleKidChange} /></Form.Group></Col>
              <Col md={4}><Form.Group controlId="kidLevel"><Form.Label>Level*</Form.Label><Form.Select name="level" value={newKid.level} onChange={handleKidChange} required>
            ...
            <Form.Group className="mb-3" controlId="kidMedicalInfo"><Form.Label>Medical Info</Form.Label><Form.Control as="textarea" rows={2} placeholder="Medical Info" name="medicalInfo" value={newKid.medicalInfo} onChange={handleKidChange} /></Form.Group>
            <Button type="submit" className="btn-warning text-dark fw-bold me-2">{editKidId ? "Update Kid" : "Add Kid"}</Button>
          </Form>
        </Card.Body>
      </Card>
      ...
      <Card className="shadow" style={{ borderRadius: '1rem', border: '2px solid #FFD700' }}>
        ...
        <Card.Body>
          <Table responsive striped bordered hover>
            <thead>
              <tr><th>Name</th><th>Age</th><th>Club</th><th>Level</th><th>Medical Info</th><th>Actions</th></tr>
            </thead>
            <tbody>
              {kidsList.map((kid) => (
                <tr key={kid.id}>
